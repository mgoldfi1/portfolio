    ...
    toggleTab = () => {
        if (this.state.currentTab === 0) {
            return (
                ...
                <Card shadow={5} style={{minWidth: '450', margin: 'auto', background: 'url(https://static1.squarespace.com/static/55c8e052e4b01bd89f02a45e/t/568ef1b2bfe8736dee55ce43/1452208563815/?format=1000w) center / cover'}}>
